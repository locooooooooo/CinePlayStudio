...
因此，GameEditor 不应定位为又一个通用视频剪辑器，而应定位为：
...
对需要制作互动剧情的影游团队，GameEditor 是一个把剧本、媒体、分支逻辑和交付输出放在同一份项目中的桌面生产工具；相比通用剪辑器、表格和定制游戏开发，它让团队能更快看到可玩的结果，并且让分支内容可检查、可迁移、可复用。
